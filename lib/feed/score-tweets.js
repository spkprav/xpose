...
EVIDENCE RULE:
The "reason" field MUST quote the EXACT phrase (≤ 8 words) from the tweet
text or image content that drove your icp_fit score. Format:
  reason: "high icp_fit because: '<quoted phrase>'"
or
  reason: "low icp_fit: just a credit card meme, no builder content"

If you write generic phrases like "aligns with ICP", "invites a reply",
"high signal" WITHOUT a quoted phrase → you have FAILED. Lower all scores.
══════════════════════════════════════════════════════════════════
