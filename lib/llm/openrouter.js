...
class OpenRouterClient {
  ...
  async chat(messages, options = {}) {
    return new Promise((resolve, reject) => {
      ...
      console.log(`[OpenRouter] Request to model: ${this.model}`);
      console.log(`[OpenRouter] API Key (first 10 chars): ${this.apiKey?.substring(0, 10)}...`);
      ...
      const req = https.request({
        ...
        res.on('end', () => {
          try {
            ...
            console.log(`[OpenRouter] Response: ${body.substring(0, 2000)}`);
            ...
            console.log(`[OpenRouter] Parse error, body:`, body.substring(0, 500));
